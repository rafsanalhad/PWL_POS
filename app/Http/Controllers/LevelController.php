...
class LevelController extends Controller
{
    ...
    public function edit(String $id)
    {
        ...
        return view('level.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'user' => $level, 'level' =>  $level, 'activeMenu' => $activeMenu]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect('/level')->with('error', 'Data level gagal dihapus karena masih terdapat tabel lain yang terkait data ini');
        }
    }
}
